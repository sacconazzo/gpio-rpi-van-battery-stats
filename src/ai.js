  ...
  const completion = await openai.chat.completions.create({
    messages: [
      ...
      },
      {
        role: "user",
        content:
          "Ti fornirò un array in formato stringificato, avrà 2 campi, ch5 e ch6, rappresentano il valore grezzo dei sensori di corrente, uno snapshot ogni 20 secondi. l'ultimo elemento il più recente. " +
          ...
          "la risposta deve essere 2 valori numerici semplici separati da virgola e nient'altro che rappresentino ch5 e ch6. Se non sei in grado di rispondere perchè non hai dati sufficienti o validi restituisci una stringa vuota.",
      },
      {
        role: "assistant",
